...
<body>
  <h4 class="text-center">Form Edit Surat Masuk</h4>
    ...
    <div class="form-group">
      ...
      <input type="text" name="tgl_surat" class="form-control" value="{{$buku->tgl_surat}}" id="exampleInputPassword1" placeholder="Masukkan Tanggal Surat">
    </div>
    <div class="form-group">
        <label for="exampleInputPassword1" class="font-weight-bold">Penulis</label>
        <input type="text" name="pengirim" class="form-control" value="{{$buku->pengirim}}" id="exampleInputPassword1" placeholder="Masukkan Pengirim">
      </div>
      <div class="form-group">
